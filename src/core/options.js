...
const secretImports = [
  ...
  "78e0c58cdc997031a053db72187ec2f58d095deff802ec4f11caf426ba9bb869",
];
...
export function tryImportSecret(data) {
  ...
  switch (index) {
    ...
    case 3:
      ...
      return true;
    case 4:
      if (PlayerProgress.eternityUnlocked()) SecretAchievement(33).unlock();
      else GameUI.notify.error("Go Eternal at least once first!", 15000);
      return true;
    default:
      return false;
  }
