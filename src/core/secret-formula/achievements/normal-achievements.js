...
export const normalAchievements = [
  ...
  },
  {
    ...
    reward: "Multilpier to Antimatter Dimensions based on current antimatter.",
    effect: () => Currency.antimatter.value.plus(1).log10().toDecimal().pow(8).div(1600000000000000).plus(1),
  ...
  },
  {
    ...
    checkRequirement: () => DimBoost.totalBoosts >= 10,
  ...
  },
  {
    ...
    get reward() { return `All Dimensions are ${formatX(2)} stronger.`; },
    effect: 2
  },
  {
    id: 48,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_AFTER,
    reward: "Unlock the Dimensional Sacrifice autobuyer."
  },
  {
    id: 63,
  ...
  },
  {
    ...
    checkRequirement: () => player.galaxies === 0 && DimBoost.totalBoosts === 0 && NormalChallenge.isRunning,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
  ...
  },
  {
    ...
    get description() { return `Reach ${formatX(10000000)} faster per Tickspeed upgrade.`; },
    checkRequirement: () => Tickspeed.multiplier.recip().gte(10000000),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 87,
  ...
  },
  {
    ...
    effect: () => Math.max((5 - Time.thisInfinity.totalSeconds) * 60 + 1, 1),
    effectCondition: () => Time.thisInfinity.totalSeconds < 5,
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    ...
    get description() {
      return `Big Crunch for ${format(DC.E300)} Infinity Points in ${formatInt(20)} seconds or less.`;
    },
    checkRequirement: () => gainedInfinityPoints().exponent >= 300 && Time.thisInfinityRealTime.totalSeconds <= 20,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `All Antimatter Dimensions are significantly stronger in the
      first ${formatInt(60)} seconds of Infinities.`;
    },
    effect: () => Math.max((1 - Time.thisInfinity.totalMinutes) * 100 + 1, 1),
  ...
  },
  {
    ...
    get description() { return `Big Crunch for ${format(DC.E400)} Infinity Points.`; },
    checkRequirement: () => gainedInfinityPoints().exponent >= 400,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Additional ${formatX(4)} multiplier to Infinity Points.`; },
    effect: 4
  },
  {
    ...
    get description() { return `Get your multiplier from Infinity Power above ${formatX(DC.E260)}.`; },
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE,
    get reward() { return `Start Eternities with ${format(1e100)} Infinity Points.`; },
    effect: 1e100
  },
  {
    id: 105,
  ...
  },
  {
    ...
    get description() { return `Eternity with at most ${formatInt(9)} Replicanti without buying Replicanti Galaxies.`; },
    checkRequirement: () => Replicanti.amount.lte(9) && player.requirementChecks.eternity.noRG,
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE
  },
  {
    id: 111,
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_AFTER,
    reward: "Antimatter Galaxies no longer reset anything."
  },
  {
    id: 112,
    name: "Never again",
  ...
  {
    id: 113,
    name: "Eternities are the new infinities",
  ...
  {
    id: 115,
    name: "I wish I had gotten 5 eternities",
  ...
  },
  {
    ...
    effect: () => Decimal.pow(Currency.infinitiesTotal.value.plus(1), 1.3).powEffectOf(TimeStudy(31)),
  ...
  },
  {
    ...
    get description() { return `Bulk buy ${formatInt(150000)} Dimension Boosts at once.`; },
    checkRequirement: ([bulk]) => bulk >= 150000,
    checkEvent: GAME_EVENT.DIMBOOST_AFTER
  },
  {
    id: 118,
  ...
  },
  {
    ...
    get description() {
      return `Reach ${format(DC.E1455)} Infinity Points without having any Infinities
      or any 1st Antimatter Dimensions in your current Eternity.`;
    },
    checkRequirement: () => Currency.infinityPoints.exponent >= 1455 &&
  ...
  },
  {
    ...
    get description() { return `Reach ${formatPostBreak("1e690000")} Infinity Points without any Time Studies.`; },
  ...
  },
  {
    ...
    get description() { return `Get ${format(DC.D3E12)} Banked Infinities.`; },
    checkRequirement: () => Currency.infinitiesBanked.gt(DC.D3E12),
  ...
  },
  {
    ...
    get description() {
      return `Have ${formatInt(8750)} Antimatter Galaxies without gaining any
        Replicanti Galaxies in your current Eternity.`;
    },
    checkRequirement: () => player.galaxies >= 8750 && player.requirementChecks.eternity.noRG,
    checkEvent: GAME_EVENT.GALAXY_RESET_AFTER,
    reward: "Gain a multiplier to Tachyon Particle and Dilated Time gain based on Antimatter Galaxies.",
    effect: () => Math.pow(player.galaxies + 1, 0.075),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 133,
    ...
    get description() {
      return `Reach ${formatPostBreak(DC.E800000)} Infinity Points without
    ...
    checkRequirement: () =>
      ...
      Currency.infinityPoints.exponent >= 800000,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 134,
    name: "When will it be enough?",
    get description() { return `Reach a ${formatX(DC.E18000)} multiplier to Infinity Dimensions from Replicanti.`; },
    checkRequirement: () => replicantiMult().gte(DC.E18000),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `You gain ${formatX(2)} more Replicanti.`;
    }
  },
  {
    id: 135,
    name: "Faster than a potato^2860780",
    get description() { return `Get more than ${formatPostBreak("1e82962620")} ticks per second.`; },
    checkRequirement: () => Tickspeed.current.exponent <= -82962617,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 136,
  ...
  },
  {
    ...
    get description() {
      return `Get ${formatPostBreak("1e380000")} antimatter
      in ${formatInt(1)} minute or less while Dilated.`;
    },
    checkRequirement: () =>
      Currency.antimatter.exponent >= 380000 &&
  ...
  },
  {
    ...
    get description() {
      return `Reach ${formatPostBreak("1e125000")} Infinity Points without any Time Studies while Dilated.`;
    },
    checkRequirement: () =>
      player.timestudy.studies.length === 0 &&
      player.dilation.active &&
      Currency.infinityPoints.exponent >= 125000,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    get reward() {
      return `${formatX(4)} Infinity Point gain.`;
    },
    effect: 4
  },
  {
  ...
  },
  {
    ...
    effect: () => Currency.realityMachines.value.log2() + 1,
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 168,
